...
- Clicking an occupied seat opens a popover with that member's details; for the host, it carries "Set as Next Host" and "Move to audience"; on your own seat, "Leave table".
